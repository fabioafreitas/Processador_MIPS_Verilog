...
// AS INSTRUÇÕES TIPO R JÁ ESTÃO COM OS FIOS SETADOS CORRETAMENTE
// FALTA SETAR ALGUNS FIOS DAS INSTRUÇÕES TIPO I E J
always @(nrst, opcode) begin : decode_thread
  ...
  if (nrst == 0) begin
    ...
    `OPCODE_BEQ: begin        // verificado
      ...
      mux_branch_jump 		= 1;
      mux_pc_branch 		= 1;
      mux_reg_src_alu_mem 	= 0;  // dont care  
    end
    
    `OPCODE_BNE: begin           // verificado
      branch 			= 1;
      read_mem 			= 0;
      write_mem 		= 0;
      write_reg 		= 0;
    ...
    `OPCODE_SB: begin        // verificado
      ...
      mux_branch_jump 		= 0;
      mux_pc_branch 		= 1;
      mux_reg_src_alu_mem 	= 1;   // dont care  
    end
    
    `OPCODE_SH: begin               // verificado
      branch 			= 0;
      read_mem 			= 0;
      write_mem 		= 1;
      write_reg 		= 0;
